...
const s_stylePath = "/css/comments.css";
const s_formId = '1FAIpQLSfmJrUHl05eJgksXLB1jlQh8qMQwsFXG83o74fuJZqZqrouhQ';
const s_nameId = '818146528';
const s_websiteId = '949302858';
const s_textId = '1914627696';
const s_pageId = '1310509685';
const s_replyId = '1476961124';
const s_sheetId = '11a7-SlXShv69TGNNT677wNCqXFfvn2wG3UaCt9h5tQQ';
...
function displayComments(comments) {
    ...
    a_commentDivs = [];
    c_container.innerHTML = '<ul id="c_list"></ul>';
...
function createComment(data) {
    ...
    // Append meta container to comment
